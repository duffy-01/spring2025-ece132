...
int main(void)
{
    ...
    portF_input_setup(GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_4);    //b10011 corresponds to SW1, N, and E respectively
    portF_output_setup(GPIO_PIN_2 | GPIO_PIN_3);       //b01100
    portD_output_setup(GPIO_PIN_2 | GPIO_PIN_6);                 // setup the pins for NS and EW on port D
